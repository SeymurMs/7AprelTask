...
namespace _7AprelTask
{
    internal class Program
    {
        ...
        {
            string directoryPath = @"C:\Users\Hp\source\repos\7AprelTask\7AprelTask\";
            ...
            do
            {
                ...
                switch (choice)
                {
                    ...
                    case "3":
                        ...
                        libraryDeSerialize = JsonConvert.DeserializeObject<Library>(JsonStrRead);
                        LastAccessTime = File.GetLastAccessTime(directoryPath + @"Files\Database.json");
                        libraryDeSerialize.RemoveBook(searchId);
                        Console.WriteLine(LastAccessTime);
